...
Linux kernel build for Archlinux with Hamad Al Marri TT CPU scheduler with Arch and other improvement patches.
...
Prebuild package are available at https://repo.blacksky3.com/x86_64/linux-tt

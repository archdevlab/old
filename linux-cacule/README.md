...
Linux kernel build for Archlinux with Hamad Al Marri CacULE CPU scheduler (kept alive artificially by Peter Jung <admin@ptr1337.dev>), AMD-PSTATE, Arch, Block, BTRFS, CPU, Futex, Wine and kernel_compiler_patch patch.

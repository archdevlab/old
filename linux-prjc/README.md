...
Linux kernel build for Archlinux with Alfred Chen PDS/BMQ CPU scheduler with Arch and other improvement patches.
...
Prebuild package are available at https://repo.blacksky3.com/x86_64/linux-prjc
